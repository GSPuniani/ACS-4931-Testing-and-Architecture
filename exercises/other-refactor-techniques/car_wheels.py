...
class Car:
    def __init__(self, engine, wheels, cabin, fuel_tank):
        self.engine = engine
        # DONE: tpms is better to be in the Wheel class. 
...
class Wheel:
    # DONE: You may add tpms as a method parameter here to 
    ...
    def install_tire(self):
        print('remove old tube.')
         # DONE: Rewrite the following after moving tpms to the 'Wheel' class
        print('cleaned tpms: ', 
    ...
    def read_tire_pressure(self):
        # DONE: After making tpms an attribute of 'Wheel' class,
